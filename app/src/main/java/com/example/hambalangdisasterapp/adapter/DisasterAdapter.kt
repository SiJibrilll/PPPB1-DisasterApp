package com.example.hambalangdisasterapp.adapter

import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import com.example.hambalangdisasterapp.databinding.ItemDisasterBinding
...
class DisasterAdapter(
    ...
    inner class ItemDisasterViewHolder(private val binding: ItemDisasterBinding) :
        ...
        fun bind(data: Disaster) = with(binding) {
            txtDisasterName.text = data.nameDisaster
            txtDisasterType.text = data.disasterType
            imgDisasterIcon.setImageResource(data.iconResId) // NEW
            itemView.setOnClickListener { onClickDisaster(data) }
        }
    }
